...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Pre_news::feed')
            ...
            ->addBreadcrumb(__('Manage News Feeds'), __('Manage News Feeds'));
        return $resultPage;
    }
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('news_feed', $model);

        /** @var \Magento\Backend\Model\View\Result\Page $resultPage */
        $resultPage = $this->_initAction();
        $resultPage->addBreadcrumb(
            $id ? __('Edit News Feed') : __('New News Feed'),
            $id ? __('EditNews Feed') : __('New News Feed')
        );
        $resultPage->getConfig()->getTitle()->prepend(__('News Feeds'));
        $resultPage->getConfig()->getTitle()
            ->prepend($model->getId() ? $model->getTitle() : __('New News Feed'));
